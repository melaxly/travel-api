...
class TourListTest extends TestCase
{
    ...
    public function test_tour_list_by_slug_returns_correct_tour(): void
    {
    ...
    public function test_tour_price_is_shown_correctly(): void
    {
        ...
        $response->assertStatus(200);
        $response->assertJsonCount(1, 'data');
        $response->assertJsonFragment(['price' => '123.25']);
    }
    ...
    public function test_tour_list_filters_by_starting_date_correctly(): void
    {
        $travel = Travel::factory()->create();
        $laterTour = Tour::factory()->create([
            'travel_id' => $travel->id,
